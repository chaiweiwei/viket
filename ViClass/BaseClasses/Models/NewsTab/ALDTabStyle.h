...
@interface ALDTabStyle : NSObject 
...
@property (nonatomic, retain) UIColor *selectedTagBgColor;
@property (nonatomic,assign) BOOL showVerticalImg; //显示后面的竖直图片
@property (nonatomic,assign) BOOL showOrderImg; //显示排序图片
...
@property (nonatomic, retain) UIImage *selectBgImage;
