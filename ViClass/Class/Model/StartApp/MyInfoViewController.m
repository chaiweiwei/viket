...
//  ViClass
//
//  Created by chaiweiwei on 15/2/3.
...
@interface MyInfoViewController()<UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIScrollViewDelegate,UITextFieldDelegate,PopupViewDelegate>
{
...
-(void)initUI
{
    ...
    logo.image = [UIImage imageNamed:@"user_default"];
    icon = logo;
    ...
    tagBtn.tag = 4;
    [tagBtn setTitle:@"群众" forState:UIControlStateNormal];
...
-(void)theNext:(UIButton *)sender
{
    switch (sender.tag) {
        ...
        case 3://完成
        {
            ...
            [httpClient modifyUserInfo:bean username:_phoneNum mobile:_phoneNum extra:nil];
        }
            break;
        case 4:
        {
