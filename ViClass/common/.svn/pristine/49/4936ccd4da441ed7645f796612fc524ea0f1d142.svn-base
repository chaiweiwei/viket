...
@implementation ALDToastView
@synthesize message=_message;
@synthesize fontSize=_textSize,showTimes=_showTimes;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor=[UIColor colorWithRed:3/255.f green:3/255.f blue:3/255.f alpha:0.7];
...
-(CGSize) captureTextSize:(int)textSize withText:(NSString *) text{
    ...
    CGSize size=[ALDUtils captureTextSizeWithText:text textWidth:self.frame.size.width-kLeftDis*2 font:[UIFont boldSystemFontOfSize:textSize]];
    return size;
}
